          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              <Link
                ...
                className="px-6 py-4 text-sm font-medium text-primary-600 border-b-2 border-primary-600"
              >
                Test Suites
              </Link>
              <Link
                href={`/projects/${projectId}/repository/${repoId}/test-plans`}
                className="px-6 py-4 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 border-b-2 border-transparent"
              >
                Test Plans
              </Link>
            </nav>
