        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-700 mb-2">
              Are you sure you want to delete <span className="font-semibold text-gray-900">{testRun.title}</span>?
            </p>
            <p className="text-xs text-gray-500">
              This will permanently delete the test run and all associated test results, comments, and attachments.
            </p>
          </div>
