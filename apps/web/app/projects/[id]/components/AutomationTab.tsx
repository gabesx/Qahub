  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <h2 className="text-2xl font-bold text-gray-900">Automated Test Cases</h2>
        <PageSizeSelector
      ...
      {isLoading ? (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600">Loading automated test cases...</p>
        </div>
      ) : testCases.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No Automated Test Cases Found</h3>
          <p className="text-gray-600">No automated test cases have been created yet.</p>
        </div>
      ) : (
        <>
